...
const rockMusicGesture = new GestureDescription('rockMusic') // 🤘
...
//------------------------------------------------------------------------------
  ...
  rockMusicGesture.addCurl(Finger.Thumb, FingerCurl.NoCurl, 1.0)
  rockMusicGesture.addCurl(Finger.Thumb, FingerCurl.HalfCurl, 0.8)

  rockMusicGesture.addCurl(Finger.Index, FingerCurl.NoCurl, 1.0)
  
  rockMusicGesture.addCurl(Finger.Pinky, FingerCurl.NoCurl, 1.0)
  
  rockMusicGesture.addCurl(Finger.Middle, FingerCurl.FullCurl, 0.8)
  rockMusicGesture.addCurl(Finger.Middle, FingerCurl.HalfCurl, 0.8)

  rockMusicGesture.addCurl(Finger.Ring, FingerCurl.FullCurl, 0.8)
  rockMusicGesture.addCurl(Finger.Ring, FingerCurl.HalfCurl, 0.8)
...
const gestures = [
  ...
  dontGesture, rockMusicGesture, oneGesture
]
export {
  gestures
}
